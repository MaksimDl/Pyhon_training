...
# in task says nothing about lower case. 
#Think we can change lower case to upper
word = word.upper()  
...
for i in word:
    print(i, end=' ')
    try:
        print("- You get",points[i])
        score += points[i]
    except KeyError:
        print("warning! found symbol not in list! we didn't count it -> ignore")
print()
print(f'for the word "{word}" you scored {score} points ')
